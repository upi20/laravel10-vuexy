...
(function (window, document, $) {
    ...
    $(window).on('load', function () {
        ...
        if ($body.hasClass('menu-collapsed') || menuCollapsed === 'true') {
            compactMenu = true;
            $('#collapse-sidebar-switch').prop('checked', menuCollapsed === 'true');
        }
        ...
        */
        ...
        // var navbarColor = localStorage.getItem('menuCollapsed');
        // var navbar = $('.header-navbar');
        // navbarColor = navbarColor === 'null' ? false : navbarColor;
        ...
        // // selector
        // var navbarColorBox = $('#customizer-navbar-colors .color-box');
        // var found = 0;
        // navbarColorBox.siblings().removeClass('selected');
        // navbarColorBox.each((i, d) => {
        //     var element = $(d);
        //     if (element.data('navbar-color') === navbarColor) {
        ...
        // if (found === 0) {
        //     navbarColorBox.first().addClass('selected');
        // }
    });
