                    ...
                    <form class="auth-register-form mt-2" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control" id="register-username" name="name"
                                value="{{ old('name') }}" placeholder="John Doe" aria-describedby="register-username"
                                tabindex="1" autofocus />
                        </div>
                        <div class="mb-1">
                            <label for="register-email" class="form-label">Email</label>
                            <input type="text" class="form-control" id="register-email" name="email"
                                value="{{ old('email') }}" placeholder="john@example.com" aria-describedby="register-email"
                                tabindex="2" />
                        </div>
